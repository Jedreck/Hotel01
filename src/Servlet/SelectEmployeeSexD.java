...
@WebServlet(name = "SelectEmployeeSexD", urlPatterns = {"/SelectEmployeeSexD"})
public class SelectEmployeeSexD extends javax.servlet.http.HttpServlet {
