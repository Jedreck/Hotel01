...
@WebServlet(name = "SelectAllAcceptedOrderServlet",urlPatterns = "/SelectAllAcceptedOrderServlet")
public class SelectAllAcceptedOrderServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            orderformList = ofd.SelectAllAcceptedOrder(page * 10);
            total = ofd.StaffGetTotalAcceptOrderNum();
